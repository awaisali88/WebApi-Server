...
namespace Dapper.Repositories
{
        ...
        where TEntity : class
    {
        ...
        /// <inheritdoc />
        public virtual IEnumerable<TEntity> FindAll<TChild1>(Expression<Func<TEntity, bool>> predicate, Expression<Func<TEntity, object>> tChild1, bool includeLogicalDeleted, IDbTransaction transaction = null)
        {
            var queryResult = SqlGenerator.GetSelectAll(predicate, includeLogicalDeleted, tChild1);
        ...
        {
            var sqlQuery = SqlGenerator.GetSelectAll(predicate, includeLogicalDeleted, tChild1, tChild2);
        ...
        public virtual IEnumerable<TEntity> FindAll<TChild1, TChild2, TChild3>(
            ...
            bool includeLogicalDeleted, IDbTransaction transaction = null)
        {
            var sqlQuery = SqlGenerator.GetSelectAll(predicate, includeLogicalDeleted, tChild1, tChild2, tChild3);
        ...
        public virtual IEnumerable<TEntity> FindAll<TChild1, TChild2, TChild3, TChild4>(
            ...
            bool includeLogicalDeleted, IDbTransaction transaction = null)
        {
            var sqlQuery = SqlGenerator.GetSelectAll(predicate, includeLogicalDeleted, tChild1, tChild2, tChild3, tChild4);
        ...
        public virtual IEnumerable<TEntity> FindAll<TChild1, TChild2, TChild3, TChild4, TChild5>(
            ...
            bool includeLogicalDeleted, IDbTransaction transaction = null)
        {
            var sqlQuery = SqlGenerator.GetSelectAll(predicate, includeLogicalDeleted, tChild1, tChild2, tChild3, tChild4, tChild5);
        ...
        public virtual IEnumerable<TEntity> FindAll<TChild1, TChild2, TChild3, TChild4, TChild5, TChild6>(
            ...
            bool includeLogicalDeleted, IDbTransaction transaction = null)
        {
            var sqlQuery = SqlGenerator.GetSelectAll(predicate, includeLogicalDeleted, tChild1, tChild2, tChild3, tChild4, tChild5, tChild6);
        ...
        /// <inheritdoc />
        public virtual Task<IEnumerable<TEntity>> FindAllAsync<TChild1>(Expression<Func<TEntity, bool>> predicate, Expression<Func<TEntity, object>> tChild1, bool includeLogicalDeleted, IDbTransaction transaction = null)
        {
            var queryResult = SqlGenerator.GetSelectAll(predicate, includeLogicalDeleted, tChild1);
