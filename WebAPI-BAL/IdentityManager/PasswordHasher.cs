        ...
        public PasswordHasher(IOptions<PasswordHasherOptions> optionsAccessor = null)
        {
            ...
            switch (_compatibilityMode)
            {
                ...
                case PasswordHasherCompatibilityMode.IdentityV3:
                    ...
                    if (_iterCount < 1)
                    {
                        throw new InvalidOperationException(ErrorMessages.InvalidPasswordHasherIterationCount);
                    }

                    break;

                default:
                    throw new InvalidOperationException(ErrorMessages.InvalidPasswordHasherCompatibilityMode);
            }
