...
namespace ElmahCore.Mvc
{
    public static class BuilderHelper
    {
        ...
        public static IServiceCollection AddElmah<T>(this IServiceCollection services) where T : ElmahCore.ErrorLog
        {
            services.AddSingleton<ErrorLogMiddleware>();
            return services.AddSingleton<ElmahCore.ErrorLog, T>();
        }
