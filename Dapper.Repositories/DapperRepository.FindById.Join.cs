...
namespace Dapper.Repositories
{
        ...
        where TEntity : class
    {
        ...
        {
            var queryResult = SqlGenerator.GetSelectById(id, includeLogicalDeleted, tChild1);
        ...
        public virtual TEntity FindById<TChild1, TChild2>(object id,
            ...
            bool includeLogicalDeleted, IDbTransaction transaction = null)
        {
            var queryResult = SqlGenerator.GetSelectById(id, includeLogicalDeleted, tChild1, tChild2);
        ...
        public virtual TEntity FindById<TChild1, TChild2, TChild3>(object id,
            ...
            bool includeLogicalDeleted, IDbTransaction transaction = null)
        {
            var queryResult = SqlGenerator.GetSelectById(id, includeLogicalDeleted, tChild1, tChild2, tChild3);
        ...
        public virtual TEntity FindById<TChild1, TChild2, TChild3, TChild4>(object id,
            ...
            bool includeLogicalDeleted, IDbTransaction transaction = null)
        {
            var queryResult = SqlGenerator.GetSelectById(id, includeLogicalDeleted, tChild1, tChild2, tChild3, tChild4);
        ...
        public virtual TEntity FindById<TChild1, TChild2, TChild3, TChild4, TChild5>(object id,
            ...
            bool includeLogicalDeleted, IDbTransaction transaction = null)
        {
            var queryResult = SqlGenerator.GetSelectById(id, includeLogicalDeleted, tChild1, tChild2, tChild3, tChild4, tChild5);
        ...
        public virtual TEntity FindById<TChild1, TChild2, TChild3, TChild4, TChild5, TChild6>(object id,
            ...
            bool includeLogicalDeleted, IDbTransaction transaction = null)
        {
            var queryResult = SqlGenerator.GetSelectById(id, includeLogicalDeleted, tChild1, tChild2, tChild3, tChild4, tChild5, tChild6);
