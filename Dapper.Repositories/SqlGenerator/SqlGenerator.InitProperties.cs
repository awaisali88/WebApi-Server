...
namespace Dapper.Repositories.SqlGenerator
{
        ...
        where TEntity : class
    {
        private void InitProperties()
        {
            ...
            var rowVresionProperty = props.FirstOrDefault(p => p.GetCustomAttributes<RowVersionAttribute>().Count() == 1);
            if (rowVresionProperty != null && (rowVresionProperty.PropertyType == typeof(byte[]) || rowVresionProperty.PropertyType == typeof(byte)))
            {
